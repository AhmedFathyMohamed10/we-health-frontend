...
const BACKENDURL = "erp/items/unit";
...
export default {
  ...
  actions: {
    ...
    async list({ commit }, params) {
      ...
      try {
        let request_query = `${BACKENDURL}/?page=${params.pageNumber}&limit=${params.rows}&name_en=${params.name_en}`
        if(params.hasOwnProperty('item_id')){
          request_query = `${BACKENDURL}/?page=${params.pageNumber}&limit=${params.rows}&name_en=${params.name_en}&item_id=${params.item_id}`
        }; 
    ...
    async getItemUnit({ commit }, params) {
      commit("setListLoading", true);
      try {
        const BACKENDURLFORUNIT = 'erp/items/product'
        let request_query = `${BACKENDURLFORUNIT}/getItemUnit?page=${params.pageNumber}&limit=${params.rows}&name_en=${params.name_en}&item_id=${params.item_id}`
    ...
    async create({ commit }, form) {
      ...
      try {
        ...
        commit("setUpsertError", error.response);
