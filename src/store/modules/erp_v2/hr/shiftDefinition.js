...
const BACKENDURL = "erp/hr/shift-definition";
...
export default {
  ...
  actions: {
    ...
    async update({ commit }, form) {
      // if (form.work_hour_from) {
      //   form.work_hour_from = this.$moment(form.work_hour_from).format("hh:mm A");
      // }
      // if (form.work_hour_to) {
      //   form.work_hour_to = this.$moment(form.work_hour_to).format("hh:mm A");
      // }
      commit("setUpsertLoading", true);
      try {
