...
const BACKENDURL = "erp/employees";
...
export default {
  ...
  getters: {
    getOneEmployee: state => state.oneEmployee,
  ...
  mutations: {
    setOneEmployee(state, data){
      console.log("data",data)
      state.oneEmployee = data
    },
    setForm(state, data) {
      console.log("data",data)
      state.form = data
  ...
  actions: {
    ...
    setOneEmployee({ commit }, payload) {
      commit('setOneEmployee', payload);
    },
    ...
    async listOneEmployee({ commit }, params) {
      try {
        ...
        commit("setOneEmployee", response.data);
