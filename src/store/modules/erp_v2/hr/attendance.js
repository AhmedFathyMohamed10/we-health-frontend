...
const BACKENDURL = "erp/hr/attendance";
...
export default {
  ...
  actions: {
    ...
    setInsert({ commit }, payload) {
      commit("setInsert", payload);
    },
    ...
    async list({ commit }, params) {
      ...
      try {
        const response = await axiosBusiness.get(
          `${BACKENDURL}/?page=${params.pageNumber}&limit=${params.rows}&employee=${params.employee}`
        );
