...
const BACKENDURL = 'erp/assets/depreciation-table';
...
export default {
  ...
  getters: {
    getIndexOfCategory: state => state.indexOfCategory,
  ...
  mutations: {
    ...
    setindexCategory(state,data){
      state.indexOfCategory = data
    },
...
// 
  ...
  actions: {
    ...
    async update({ commit,state },form) {
      ...
      let data={
        "form":form,
        "indexOfCategory":state.indexOfCategory,
      }
      try {
