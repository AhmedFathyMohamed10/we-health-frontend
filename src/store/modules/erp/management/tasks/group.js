...
export default {
    ...
    actions: {
        ...
        async list({ commit }, params) {
            ...
            try {
                const response = await axiosBusiness.get(`erp/management/group/?page=${params.pageNumber}&limit=${params.rows}&name=${params.name}`);
        ...
        async create({ commit }, form) {
            ...
            try {
                const response = await axiosBusiness.post(`erp/management/group/create`, form);
                console.log(response);
        ...
        async update({ commit }, form) {
            commit('setUpsertLoading', true)
            try {
                const response = await axiosBusiness.put(`erp/management/group/update/${form.id}`, form);
                console.log(response);
        ...
        async changeStatus({ commit }, payload) {
            ...
            try {
                const response = await axiosBusiness.put(`erp/management/group/change-status`, payload)
