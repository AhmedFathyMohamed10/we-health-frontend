...
export default {
    ...
    mutations: {
        ...
        sortStatuses(state, payload) {
            state.listResponse.results = [...payload]
        }
    },
    // use to perform un asynchronous tasks
    actions: {
        sortStatuses(context, payload) {
            context.commit('sortStatuses', payload);
            //TODO

            // context.dispatch('sort',payload) // after creating logic of sorting in backend uncomment this
        },
        //TODO

        // after creating logic of sorting in backend uncomment this
        // async sort({ commit }, params) {
        //     commit('setListLoading', true)
        //     try {
        //         const response = await axiosBusiness.get(`erp/management/status/?page=${params.pageNumber}&limit=${params.rows}&name=${params.name}`);
        ...
        async create({ commit }, form) {
            ...
            try {
                const response = await axiosBusiness.post(`erp/management/status/create`, form);
                console.log(response);
        ...
        async update({ commit }, form) {
            commit('setUpsertLoading', true)
            try {
                const response = await axiosBusiness.put(`erp/management/status/update/${form.id}`, form);
                console.log(response);
        ...
        async changeStatus({ commit }, payload) {
            ...
            try {
                const response = await axiosBusiness.put(`erp/management/status/change-status`, payload)
