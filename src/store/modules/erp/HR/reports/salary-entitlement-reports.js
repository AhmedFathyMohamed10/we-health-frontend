...
const BACKENDURL = "erp/hr-reports";
...
export default {
  ...
  actions: {
    ...
    async list({ commit }, params) {
      ...
      try {
        const response = await axiosBusiness.get(`${BACKENDURL}/get-salary-entitlement-report?page=${params.pageNumber}&limit=${params.rows}`
                  )
