...
export default {
  ...
  actions: {
    ...
    async update({ commit, dispatch }, form) {
      ...
      const { salary_due_date, reminder_salary_due_Date, annual_vacations_days, code,report_apperance_duration } = form
      let data =  { salary_due_date, reminder_salary_due_Date, annual_vacations_days, code ,report_apperance_duration};
      console.log(data)
      // commit('setUpsertLoading', true)
      try {
