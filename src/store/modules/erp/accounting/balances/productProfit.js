...
export default {
  ...
  actions: {
    ...
    async list({ commit }, params) {
      ...
      try {
        const response = await axiosBusiness.get(`erp/accounting/balances/product-profit?page=${params.pageNumber}&limit=${params.rows}&product_id=${params.product_id}&statement_type=${params.statement_type}&start_date=${params.start_date}&end_date=${params.end_date}`);
