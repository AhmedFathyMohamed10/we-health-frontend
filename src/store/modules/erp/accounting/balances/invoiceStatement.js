...
export default {
  ...
  actions: {
    ...
    async list({ commit }, params) {
      ...
      try {
        const response = await axiosBusiness.get(`erp/accounting/balances/invoice_statement?page=${params.pageNumber}&limit=${params.rows}&statement_type=${params.statement_type}&invoices_type=${params.invoices_type}&start_date=${params.start_date}&end_date=${params.end_date}`);
