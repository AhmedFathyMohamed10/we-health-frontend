  ...
  actions: {
    ...
    async list({ commit }, params) {
      ...
      try {
        ...
        const response = await axiosBusiness.get(`erp/accounting/invoices/definition/?page=${params.pageNumber}&limit=${params.rows}&name=${params.name}&invoice_type=${params.invoice_type}&category=${params.category}&group=${params.group}&customer_account=${params.customer_account?params.customer_account.id:''}&cash_account=${params.cash_account?params.cash_account.id:''}&material_account=${params.material_account?params.material_account.id:''}&discount_account=${params.discount_account?params.discount_account.id:''}&policy=${params.policy}&method=${params.method}`);
    ...
    async create({ commit }, form) {
      ...
      try {
        const response = await axiosBusiness.post(`erp/accounting/invoices/definition/create`, form);
        console.log(response);
    ...
    async update({ commit }, form) {
      ...
      commit('setUpsertLoading', true)
      try {
        const response = await axiosBusiness.put(`erp/accounting/invoices/definition/update/${form.id}`,form);
        console.log(response);
    ...
    async changeStatus({ commit }, payload) {
      ...
      try {
        const response = await axiosBusiness.put(`erp/accounting/invoices/definition/change-status`, payload)
