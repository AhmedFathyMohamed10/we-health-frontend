...
export default {
  ...
  actions: {
    ...
    async create(context, form) {
      ...
      try {
        const response = await axios.post(`${prefix}/create-pulse-rate`, {data:form});
        // console.log(response);
        context.commit('setUpsertResponse', response.data)
        context.commit("measurements/create", {key:'pulseRate', value:{...response.data}},{ root: true });
    ...
    async update(context, form) {
      ...
      try {
        ...
        console.log(response);
        context.commit('setUpsertResponse', response.data)
        context.commit("measurements/update", {key:'pulseRate', value:{...response.data}},{ root: true });
        context.commit('setUpsertError', null)
        return Promise.resolve(response)
      } catch (error) {
        console.log(error)
    ...
    async delete(context, id) {
      ...
      try {
        ...
        context.commit("measurements/delete", {key:'pulseRate', value:id},{ root: true });
