...
export default {
  ...
  actions: {
    ...
    async create(context, form) {
      ...
      try {
        const response = await axios.post(`${prefix}/create-Inbody`, {data:form});
        // console.log(response);
        context.commit('setUpsertResponse', response.data)
        context.commit("measurements/create", {key:'Inbody', value:{...response.data}},{ root: true });
    ...
    async update(context, form) {
      ...
      try {
        ...
        console.log(response);
        context.commit('setUpsertResponse', response.data)
        context.commit("measurements/update", {key:'Inbody', value:{...response.data}},{ root: true });
        context.commit('setUpsertError', null)
        return Promise.resolve(response)
      } catch (error) {
        console.log(error)
    ...
    async delete(context, id) {
      ...
      try {
        ...
        context.commit("measurements/delete", {key:'Inbody', value:id},{ root: true });
