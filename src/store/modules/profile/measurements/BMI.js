...
export default {
  ...
  actions: {
    ...
    async create(context, form) {
      ...
      try {
        const response = await axios.post(`${prefix}/create-BMI`, {data:form});
        // console.log(response);
        context.commit('setUpsertResponse', response.data)
        context.commit("measurements/create", {key:'BMI', value:{...response.data}},{ root: true });
    ...
    async update(context, form) {
      ...
      try {
        ...
        console.log(response);
        context.commit('setUpsertResponse', response.data)
        context.commit("measurements/update", {key:'BMI', value:{...response.data}},{ root: true });
        context.commit('setUpsertError', null)
        return Promise.resolve(response)
      } catch (error) {
        console.log(error)
    ...
    async delete(context, id) {
      ...
      try {
        ...
        context.commit("measurements/delete", {key:'BMI', value:id},{ root: true });
