...
export default {
  ...
  actions: {
    ...
    async create(context, form) {
      ...
      try {
        const response = await axios.post(`${prefix}/create-Oxygen-level`, {data:form});
        // console.log(response);
        context.commit('setUpsertResponse', response.data)
        context.commit("measurements/create", {key:'OxygenLevel', value:{...response.data}},{ root: true });
    ...
    async update(context, form) {
      ...
      try {
        ...
        console.log(response);
        context.commit('setUpsertResponse', response.data)
        context.commit("measurements/update", {key:'OxygenLevel', value:{...response.data}},{ root: true });
        context.commit('setUpsertError', null)
        return Promise.resolve(response)
      } catch (error) {
        console.log(error)
    ...
    async delete(context, id) {
      ...
      try {
        ...
        context.commit("measurements/delete", {key:'OxygenLevel', value:id},{ root: true });
