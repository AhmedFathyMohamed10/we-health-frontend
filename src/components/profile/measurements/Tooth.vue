  ...
  <div class="pulse-rate">
    <div class="pulse-rate-header d-flex justify-content-between align-items-center">
      <div class="d-flex gap-2 align-items-center">
        <h4 class="mb-0"><i class="pi pi-th-large fs-2 text-success-gradient"></i></h4>
    ...
    <DetailsDialog :display="displayDetailsDialog" @hide="closeDetailsDialog" :header="$t('header.title')" :maximizable="true">
       <div class="row">
        <div class="col-md-12">
          ...
          <div class="">
            <h4><i class="pi pi-th-large fs-2 text-success-gradient"></i></h4>
          </div>
          <div class="">
...
import {htmlTagsError,maxLengthError,requiredError, } from "@/validation/errors";
...
export default {
  ...
  methods: {
    ...
    resetForm(){
      this.form = {beats:null,};
      this.closeForm();
      this.upsertResponse=null;
      this.upsertError=null;
    },
    create(){
      this.$store.dispatch("measurements/Tooth/create", this.form)
      .then((res) => {
        this.resetForm();
    ...
    update(){
      this.$store.dispatch("measurements/Tooth/update", this.form)
      .then((res) => {
        this.resetForm();
        const summery = res.statusText; 
        const details =  res.data.message;
    ...
    deleteRecord() {
      this.$store.dispatch("measurements/Tooth/delete", this.recordId)
      .then((res) => {
        const summery = res.statusText; 
        const details =  res.data.message;
        this.successToast(summery,details)
