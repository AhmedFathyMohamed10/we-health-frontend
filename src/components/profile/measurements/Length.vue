  ...
  <div class="pulse-rate">
    <div class="pulse-rate-header d-flex justify-content-between align-items-center">
      <div class="d-flex gap-2 align-items-center">
        <h4 class="mb-0"><i class="pi pi-building fs-2 text-success-gradient"></i></h4>
    ...
    <DetailsDialog :display="displayDetailsDialog" @hide="closeDetailsDialog" :header="$t('header.title')" :maximizable="true">
       <div class="row">
        <div class="col-md-12">
          ...
          <div class="">
            <h4><i class="pi pi-building  fs-2 text-success-gradient"></i></h4>
          </div>
          <div class="">
              ...
              <table class="table table-borderless text-nowrap mb-0">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td ><span class="result-msg fw-bold text-start text-white px-3 py-1" :style="{ background: gradientBg(getBeatsResult(form.cm,age).status) }">{{getBeatsResult(form.cm,age).message}}</span></td>
...
export default {
  ...
  computed:{
    ...
    ...mapGetters("measurements/Length", {
  ...
  methods: {
    ...
    ...mapActions("measurements/Length",
    ...
    create(){
      this.$store.dispatch("measurements/Length/create", this.form)
      .then((res) => {
        // console.log(res)
        this.resetForm();
    ...
    update(){
      this.$store.dispatch("measurements/Length/update", this.form)
      .then((res) => {
        // console.log(res)
        this.resetForm();
        const summery = res.statusText; 
    ...
    deleteRecord() {
      this.$store.dispatch("measurements/Length/delete", this.recordId)
      .then((res) => {
        // console.log(res)
        const summery = res.statusText; 
        const details =  res.data.message;
