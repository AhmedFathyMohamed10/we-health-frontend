  ...
  <div class="pulse-rate">
    <div class="pulse-rate-header d-flex justify-content-between align-items-center">
      <div class="d-flex gap-2 align-items-center">
        <h4 class="mb-0"><i class="pi pi-user fs-2 text-success-gradient"></i></h4>
    ...
    <DetailsDialog :display="displayDetailsDialog" @hide="closeDetailsDialog" :header="$t('header.title')" :maximizable="true">
       <div class="row">
        <div class="col-md-12">
          ...
          <div class="">
            <h4><i class="pi pi-user  fs-2 text-success-gradient"></i></h4>
          </div>
          <div class="">
...
export default {
  ...
  methods: {
    ...
    create(){
      this.$store.dispatch("measurements/Steps/create", this.form)
      .then((res) => {
        // console.log(res)
        this.resetForm();
    ...
    update(){
      this.$store.dispatch("measurements/Steps/update", this.form)
      .then((res) => {
        // console.log(res)
        this.resetForm();
        const summery = res.statusText; 
    ...
    deleteRecord() {
      this.$store.dispatch("measurements/Steps/delete", this.recordId)
      .then((res) => {
        // console.log(res)
        const summery = res.statusText; 
        const details =  res.data.message;
