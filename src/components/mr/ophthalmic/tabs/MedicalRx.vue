<template>
          ...
          <div class="row">
                  ...
                  <div class="form-group period">
                      ...
                      <div class="error">
                          ...
                          <small class="p-invalid" 
                              v-else-if="$v.rowToAdd.period.value.$error && !$v.rowToAdd.period.value.maxValue">
              ...
              <div class="col-md-4">
                  <div class="form-group refill">
                      ...
                      <div class="p-inputgroup">
                          <span class="p-inputgroup-addon"
                          :class="{'p-invalid':$v.rowToAdd.refill.$error  }">
                              <i class="mdi mdi-pill"></i>
                          </span>
                          <InputText 
                              type="number" 
                              class="form-control" 
                              v-model="rowToAdd.refill"
                      ...
                      <div class="error">
                            <small class="p-invalid"
                                    v-if="$v.rowToAdd.refill.$error && !$v.rowToAdd.refill.numeric" >
                                    {{numericError($t('rx.refill.label'))}}
                            </small>
                            <small class="p-invalid" 
                                    v-else-if="$v.rowToAdd.refill.$error && !$v.rowToAdd.refill.maxValue">
                                    {{maxValueError($t('rx.refill.label'),$v.rowToAdd.refill.$params.maxValue.max)}}
                            </small>
                  ...
                  <table class="table table-sm text-center">
                      <thead>
                          <tr>
                              ...
                              <th scope="col">{{$t('rx.eye.label')}}</th>
                              <th scope="col">{{$t('rx.refill.label')}}</th>
                      ...
                      <tbody>
                          <tr v-for="(val, index) in rx" :key="index">
                              ...
                              <td class="align-middle">
                                  <div v-if="val.frequency">{{val.frequency.join("/")}}</div>
                              </td>
                              <td class="align-middle">
                                  <div v-if="val.form">
                                      {{val.form.value}}
                              ...
                              <td class="align-middle">
                                <div v-if="val.eye">{{val.eye.value}}</div>
                             </td>
                             <td class="align-middle">
                                <div v-if="val.refill">{{val.refill}}</div>
                             </td>
                              <td class="align-middle">
              ...
              <div class="col-md-6 col-xxl-4">
                  <div class="form-group dose" v-if="rowToEdit.dose">
                      <CustomInputGroup 
                          ...
                          :dropdownPlaceholder="$t('rx.dose.dropdownPlaceholder')"
                          :options="doseTypeOptions" 
                          :invalidValue="$v.rowToEdit.dose.value.$error"
                      />
                      <div class="error">
                          <small 
                              class="p-invalid" 
              ...
              <div class="col-md-6 col-xxl-4">
                  <div class="form-group period">
                      ...
                      <div class="error">
                          ...
                          <small class="p-invalid" 
                              v-else-if="$v.rowToEdit.period.value.$error && !$v.rowToEdit.period.value.maxValue">
              ...
              <div class="col-md-6 col-xxl-4">
               ...
               <div class="col-md-6 col-xxl-4">
                  <div class="form-group refill">
                      ...
                      <div class="p-inputgroup">
                          <span class="p-inputgroup-addon"
                          :class="{'p-invalid':$v.rowToEdit.refill.$error }">
                              <i class="mdi mdi-pill"></i>
                          </span>
                          <InputText 
                              type="number" 
                      ...
                      <div class="error">
                            <small class="p-invalid"
                                    v-if="$v.rowToEdit.refill.$error && !$v.rowToEdit.refill.numeric" >
                                    {{numericError($t('rx.refill.label'))}}
                            </small>
                            <small class="p-invalid" 
                                    v-else-if="$v.rowToEdit.refill.$error && !$v.rowToEdit.refill.maxValue">
                                    {{maxValueError($t('rx.refill.label'),$v.rowToEdit.refill.$params.maxValue.max)}}
                            </small>
           ...
           <div class="col-md-6 col-xxl-4">
            ...
            <div class="col-md-6 col-xxl-4">
                  <div class="form-group note">
                      ...
                      <small 
                          v-else-if="! $v.rowToEdit.note.minLength &&  $v.rowToEdit.note.$error" 
                          class="p-invalid"
                          >{{minLengthError($t('rx.note.label'), $v.rowToEdit.note.$params.minLength.min)}}
                      </small>
                      <small 
                          v-else-if="! $v.rowToEdit.note.maxLength &&  $v.rowToEdit.note.$error" 
                          class="p-invalid">{{maxLengthError($t('rx.note.label'), $v.rowToEdit.note.$params.maxLength.max)}}
                      </small> 
                  </div>
              </div>
          </div>
    ...
    import rxOptions from '@/mixins/mr/ophthalmic/options/rxOptions'
    ...
    export default {
        ...
        ////////////////////////////////////
        computed: {
          ...mapGetters("detailsOphthalmic/ophthalmic", ["getMedicalRx"]),
          rx: {
              get() {
                  return this.getMedicalRx;
              },
              set(value) {
                  this.$store.dispatch("detailsOphthalmic/ophthalmic/setMedicalRx", value);
              },
          }
      },
        /////////////////////////////////////
