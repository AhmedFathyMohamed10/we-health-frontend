  ...
  <div class="over-refraction">
        ...
        <div class="row" v-if="!switchChecked">
            ...
            <div class="col-md-3 col-xxl-2">
                <div class="form-group">
                    <CustomDropMenu 
                        v-model="overRefraction.near.od.spherical"
                        :label="$t('measurementsLabels.spherical')"
                        :options="sphericalOptions"
                        :excludeColumn="0"
                        :invalid="
                            (v.near.od.spherical.$error)||
                            (check_error.od?
            ...
            <div class="col-md-3 col-xxl-2">
                <div class="form-group">
                    <!-- Cylindrical -->
                    <CustomDropMenu 
                        v-model="overRefraction.near.od.cylindrical"
                        :label="$t('measurementsLabels.cylindrical')"
                        :options="cylindricalOptions"
                        :excludeColumn="0"
                        :invalid="
                            (v.near.od.cylindrical.$error)||
                            (check_error.od?
            ...
            <div class="col-md-3 col-xxl-2">
                <div class="form-group">
                    <!-- Axis -->
                    <CustomDropMenu 
                        v-model="overRefraction.near.od.axis"
                        :label="$t('measurementsLabels.axis')"
                        :options="axisOptions"
                        :invalid="
                            (v.near.od.axis.$error)||
                            (check_error.od?
            ...
            <div class="col-md-3 col-xxl-2">
                <div class="form-group">
                    <!-- Add -->
                    <CustomDropMenu 
                        v-model="overRefraction.near.od.add"
            ...
            <div class="col-md-3 col-xxl-2" v-if="toggleSimpleOrAdvanced == 'advanced'">
                <div class="form-group">
                    <!-- Prism -->
                    <CustomDropMenu 
                        v-model="overRefraction.near.od.prism"
                        :label="$t('measurementsLabels.prism')"
                        :options="prismOptions"
                        :invalid="
                            (v.near.od.prism.$error)||
                            (check_error.od?
            ...
            <div class="col-md-3 col-xxl-2" v-if="toggleSimpleOrAdvanced == 'advanced'">
                <div class="form-group">
                    <!-- NVA -->
                    <CustomDropMenu 
                        v-model="overRefraction.near.od.nva"
        ...
        <div class="row" v-if="!switchChecked">
            ...
            <div class="col-md-3 col-xxl-2">
                <div class="form-group">
                    <CustomDropMenu 
                        v-model="overRefraction.near.os.spherical"
                        :label="$t('measurementsLabels.spherical')"
                        :options="sphericalOptions"
                        :excludeColumn="0"
                        :invalid="
                            (v.near.os.spherical.$error)||
                            (check_error.os?
            ...
            <div class="col-md-3 col-xxl-2">
                <div class="form-group">
                    <!-- Cylindrical -->
                    <CustomDropMenu 
                        v-model="overRefraction.near.os.cylindrical"
                        :label="$t('measurementsLabels.cylindrical')"
                        :options="cylindricalOptions"
                        :excludeColumn="0"
                        :invalid="
                            (v.near.os.cylindrical.$error)||
                            (check_error.os?
            ...
            <div class="col-md-3 col-xxl-2">
                <div class="form-group">
                    <!-- Axis -->
                    <CustomDropMenu 
                        v-model="overRefraction.near.os.axis"
                        :label="$t('measurementsLabels.axis')"
                        :options="axisOptions"
                        :invalid="
                            (v.near.os.axis.$error)||
                            (check_error.os?
            ...
            <div class="col-md-3 col-xxl-2">
                <div class="form-group">
                    <!-- Add -->
                    <CustomDropMenu 
                        v-model="overRefraction.near.os.add"
                        :label="$t('measurementsLabels.add')"
                        :options="addOptions"
                        :invalid="
                            (v.near.os.add.$error)||
            ...
            <div class="col-md-3 col-xxl-2" v-if="toggleSimpleOrAdvanced == 'advanced'">
                <div class="form-group">
                    <!-- Prism -->
                    <CustomDropMenu 
                        v-model="overRefraction.near.os.prism"
                        :label="$t('measurementsLabels.prism')"
                        :options="prismOptions"
                        :invalid="
            ...
            <div class="col-md-3 col-xxl-2" v-if="toggleSimpleOrAdvanced == 'advanced'">
                <div class="form-group">
                    <!-- NVA -->
                    <CustomDropMenu 
                        v-model="overRefraction.near.os.nva"
                        :label="$t('measurementsLabels.nva')"
                        :options="nvaOptions"
                        :invalid="
                            (v.near.os.nva.$error)||
        ...
        <div class="row" v-if="!switchChecked">
            ...
            <div class="col-md-3 col-xxl-2">
                <div class="form-group">
                    <!-- Dva -->
                    <CustomDropMenu 
                        v-model="overRefraction.near.ou.dva"
            ...
            <div class="col-md-3 col-xxl-2">
                <div class="form-group">
                    <!-- NVA -->
                    <CustomDropMenu 
                        v-model="overRefraction.near.ou.nva"
                        :label="$t('measurementsLabels.nva')"
                        :options="nvaOptions"
                        :invalid="
                            (v.near.ou.nva.$error)||
        ...
        <div class="row" v-if="switchChecked">
            ...
            <div class="col-md-3 col-xxl-2">
                <div class="form-group">
                    <CustomDropMenu 
                        v-model="overRefraction.distant.od.spherical"
                        :label="$t('measurementsLabels.spherical')"
                        :options="sphericalOptions"
                        :excludeColumn="0"
                        :invalid="
            ...
            <div class="col-md-3 col-xxl-2">
                <div class="form-group">
                    <!-- Cylindrical -->
                    <CustomDropMenu 
                        v-model="overRefraction.distant.od.cylindrical"
                        :label="$t('measurementsLabels.cylindrical')"
                        :options="cylindricalOptions"
                        :excludeColumn="0"
                        :invalid="
            ...
            <div class="col-md-3 col-xxl-2">
                <div class="form-group">
                    <!-- Axis -->
                    <CustomDropMenu 
                        v-model="overRefraction.distant.od.axis"
                        :label="$t('measurementsLabels.axis')"
                        :options="axisOptions"
                        :invalid="
            ...
            <div class="col-md-3 col-xxl-2">
                <div class="form-group">
                    <!-- Add -->
                    <CustomDropMenu 
                        v-model="overRefraction.distant.od.add"
                        :label="$t('measurementsLabels.add')"
                        :options="addOptions"
                        :invalid="
            ...
            <div class="col-md-3 col-xxl-2" v-if="toggleSimpleOrAdvanced == 'advanced'">
                <div class="form-group">
                    <!-- Prism -->
                    <CustomDropMenu 
                        v-model="overRefraction.distant.od.prism"
                        :label="$t('measurementsLabels.prism')"
                        :options="prismOptions"
                        :invalid="
            ...
            <div class="col-md-3 col-xxl-2" v-if="toggleSimpleOrAdvanced == 'advanced'">
                <div class="form-group">
                    <!-- Dva -->
                    <CustomDropMenu 
                        v-model="overRefraction.distant.od.dva"
                        :label="$t('measurementsLabels.dva')"
                        :options="dvaOptions"
                        :invalid="
        ...
        <div class="row" v-if="switchChecked">
            ...
            <div class="col-md-3 col-xxl-2">
                <div class="form-group">
                    <CustomDropMenu 
                        v-model="overRefraction.distant.os.spherical"
                        :label="$t('measurementsLabels.spherical')"
                        :options="sphericalOptions"
                        :excludeColumn="0"
                        :invalid="
            ...
            <div class="col-md-3 col-xxl-2">
                <div class="form-group">
                    <!-- Cylindrical -->
                    <CustomDropMenu 
                        v-model="overRefraction.distant.os.cylindrical"
                        :label="$t('measurementsLabels.cylindrical')"
                        :options="cylindricalOptions"
                        :excludeColumn="0"
                        :invalid="
            ...
            <div class="col-md-3 col-xxl-2">
                <div class="form-group">
                    <!-- Axis -->
                    <CustomDropMenu 
                        v-model="overRefraction.distant.os.axis"
                        :label="$t('measurementsLabels.axis')"
                        :options="axisOptions"
                        :invalid="
            ...
            <div class="col-md-3 col-xxl-2">
                <div class="form-group">
                    <!-- Add -->
                    <CustomDropMenu 
                        v-model="overRefraction.distant.os.add"
                        :label="$t('measurementsLabels.add')"
                        :options="addOptions"
                        :invalid="
            ...
            <div class="col-md-3 col-xxl-2" v-if="toggleSimpleOrAdvanced == 'advanced'">
                <div class="form-group">
                    <!-- Prism -->
                    <CustomDropMenu 
                        v-model="overRefraction.distant.os.prism"
                        :label="$t('measurementsLabels.prism')"
                        :options="prismOptions"
                        :invalid="
            ...
            <div class="col-md-3 col-xxl-2" v-if="toggleSimpleOrAdvanced == 'advanced'">
                <div class="form-group">
                    <!-- Dva -->
                    <CustomDropMenu 
                        v-model="overRefraction.distant.os.dva"
                        :label="$t('measurementsLabels.dva')"
                        :options="dvaOptions"
                        :invalid="
        ...
        <div class="row" v-if="switchChecked">
            ...
            <div class="col-md-3 col-xxl-2">
                <div class="form-group">
                    <!-- Dva -->
                    <CustomDropMenu 
                        v-model="overRefraction.distant.ou.dva"
                        :label="$t('measurementsLabels.dva')"
                        :options="dvaOptions"
                        :invalid="
            ...
            <div class="col-md-3 col-xxl-2">
                <div class="form-group">
                    <!-- NVA -->
                    <CustomDropMenu 
                        v-model="overRefraction.distant.ou.nva"
                        :label="$t('measurementsLabels.nva')"
                        :options="nvaOptions"
                        :invalid="
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <label class="form-label">{{$t('overRefraction.note.label')}}</label>
                    <textarea 
                        v-model="overRefraction.note" 
                        :placeholder="$t('overRefraction.note.placeholder')" 
                        class="form-control"
                        :class="{
                            'is-invalid':
                            (v.note.$error)
                    ...
                    <div v-if="v.note.$error && !v.note.notContainsHtmlTags" class="invalid-feedback">
                            {{htmlTagsError($t('overRefraction.note.label'))}}
                    </div>
                    <div v-else-if="! v.note.minLength &&  v.note.$error" class="invalid-feedback">
                            {{minLengthError($t('overRefraction.note.label'), v.note.$params.minLength.min)}}
                    </div>
                    <div v-else-if="! v.note.maxLength &&  v.note.$error" class="invalid-feedback">
                            {{maxLengthError($t('overRefraction.note.label'), v.note.$params.maxLength.max)}}
                    </div> 
                </div>
            </div>
        </div>
...
export default {
    ...
    computed: {
        ...mapGetters("detailsOphthalmic/ophthalmic", ["getOverRefraction"]),
        overRefraction: {
            get() {
                return this.getOverRefraction;
            },
            set(value) {
                this.$store.dispatch("detailsOphthalmic/ophthalmic/setOverRefraction", value);
            },
        }
    },
    methods:{
        ...
        ///////////////////////////
         ...
         ///////////////////////
        copyToOdNear(){
                this.overRefraction.near.od=JSON.parse(JSON.stringify(this.overRefraction.near.os));
        },
        copyToOsNear(){
            this.overRefraction.near.os=JSON.parse(JSON.stringify(this.overRefraction.near.od));
        },
        copyToOdDistant(){
                this.overRefraction.distant.od=JSON.parse(JSON.stringify(this.overRefraction.distant.os));
        },
        copyToOsDistant(){
            this.overRefraction.distant.os=JSON.parse(JSON.stringify(this.overRefraction.distant.od));
        },
    },
}
</script>
