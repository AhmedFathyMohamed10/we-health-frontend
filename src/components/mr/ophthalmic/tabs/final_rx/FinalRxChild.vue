        ...
        <!-- Input Switch -->
            ...
            <div class="row" v-if="!switchChecked">
                ...
                <div class="col-md-3 col-xxl-2"> 
                    <div class="form-group">
                        <CustomDropMenu 
                            v-model="measurements.near.od.spherical"
                ...
                <div class="col-md-3 col-xxl-2">
                    <div class="form-group">
                        <!-- Cylindrical -->
                        <CustomDropMenu 
                            v-model="measurements.near.od.cylindrical"
                ...
                <div class="col-md-3 col-xxl-2">
                    <div class="form-group">
                        <!-- Axis -->
                        <CustomDropMenu 
                            v-model="measurements.near.od.axis"
                ...
                <div class="col-md-3 col-xxl-2">
                    <div class="form-group">
                        <!-- Add -->
                        <CustomDropMenu 
                            v-model="measurements.near.od.add"
                ...
                <div class="col-md-3 col-xxl-2" v-if="toggleSimpleOrAdvanced == 'advanced'">
                    <div class="form-group">
                        <!-- Prism -->
                        <CustomDropMenu 
                            v-model="measurements.near.od.prism"
                ...
                <div class="col-md-3 col-xxl-2" v-if="toggleSimpleOrAdvanced == 'advanced'">
                    <div class="form-group">
                        <!-- NVA -->
                        <CustomDropMenu 
                            v-model="measurements.near.od.nva"
            ...
            <div class="row" v-if="!switchChecked">
                ...
                <div class="col-md-3 col-xxl-2">
                    <div class="form-group">
                        <CustomDropMenu 
                            v-model="measurements.near.os.spherical"
                            :label="$t('measurementsLabels.spherical')"
                            :options="sphericalOptions"
                            :excludeColumn="0"
                            :invalid="
                ...
                <div class="col-md-3 col-xxl-2">
                    <div class="form-group">
                        <!-- Cylindrical -->
                        <CustomDropMenu 
                            v-model="measurements.near.os.cylindrical"
                            :label="$t('measurementsLabels.cylindrical')"
                            :options="cylindricalOptions"
                            :excludeColumn="0"
                            :invalid="
                ...
                <div class="col-md-3 col-xxl-2">
                    <div class="form-group">
                        <!-- Axis -->
                        <CustomDropMenu 
                            v-model="measurements.near.os.axis"
                            :label="$t('measurementsLabels.axis')"
                            :options="axisOptions"
                            :invalid="
                ...
                <div class="col-md-3 col-xxl-2">
                    <div class="form-group">
                        <!-- Add -->
                        <CustomDropMenu 
                            v-model="measurements.near.os.add"
                            :label="$t('measurementsLabels.add')"
                            :options="addOptions"
                            :invalid="
                                (v.near.os.add.$error)||
                ...
                <div class="col-md-3 col-xxl-2" v-if="toggleSimpleOrAdvanced == 'advanced'">
                    <div class="form-group">
                        <!-- Prism -->
                        <CustomDropMenu 
                            v-model="measurements.near.os.prism"
                            :label="$t('measurementsLabels.prism')"
                            :options="prismOptions"
                            :invalid="
                ...
                <div class="col-md-3 col-xxl-2" v-if="toggleSimpleOrAdvanced == 'advanced'">
                    <div class="form-group">
                        <!-- NVA -->
                        <CustomDropMenu 
                            v-model="measurements.near.os.nva"
                            :label="$t('measurementsLabels.nva')"
                            :options="nvaOptions"
                            :invalid="
                                (v.near.os.nva.$error)||
            ...
            <div class="row" v-if="!switchChecked">
                ...
                <div class="col-md-3 col-xxl-2">
                    <div class="form-group">
                        <!-- Dva -->
                        <CustomDropMenu 
                            v-model="measurements.near.ou.dva"
                ...
                <div class="col-md-3 col-xxl-2">
                    <div class="form-group">
                        <!-- NVA -->
                        <CustomDropMenu 
                            v-model="measurements.near.ou.nva"
                            :label="$t('measurementsLabels.nva')"
                            :options="nvaOptions"
                            :invalid="
                                (v.near.ou.nva.$error)||
            ...
            <div class="row" v-if="switchChecked">
                ...
                <div class="col-md-3 col-xxl-2">
                    <div class="form-group">
                        <CustomDropMenu 
                            v-model="measurements.distant.od.spherical"
                            :label="$t('measurementsLabels.spherical')"
                            :options="sphericalOptions"
                            :excludeColumn="0"
                            :invalid="
                ...
                <div class="col-md-3 col-xxl-2">
                    <div class="form-group">
                        <!-- Cylindrical -->
                        <CustomDropMenu 
                            v-model="measurements.distant.od.cylindrical"
                            :label="$t('measurementsLabels.cylindrical')"
                            :options="cylindricalOptions"
                            :excludeColumn="0"
                            :invalid="
                ...
                <div class="col-md-3 col-xxl-2">
                    <div class="form-group">
                        <!-- Axis -->
                        <CustomDropMenu 
                            v-model="measurements.distant.od.axis"
                            :label="$t('measurementsLabels.axis')"
                            :options="axisOptions"
                            :invalid="
                ...
                <div class="col-md-3 col-xxl-2">
                    <div class="form-group">
                        <!-- Add -->
                        <CustomDropMenu 
                            v-model="measurements.distant.od.add"
                            :label="$t('measurementsLabels.add')"
                            :options="addOptions"
                            :invalid="
                ...
                <div class="col-md-3 col-xxl-2" v-if="toggleSimpleOrAdvanced == 'advanced'">
                    <div class="form-group">
                        <!-- Prism -->
                        <CustomDropMenu 
                            v-model="measurements.distant.od.prism"
                            :label="$t('measurementsLabels.prism')"
                            :options="prismOptions"
                            :invalid="
                ...
                <div class="col-md-3 col-xxl-2" v-if="toggleSimpleOrAdvanced == 'advanced'">
                    <div class="form-group">
                        <!-- Dva -->
                        <CustomDropMenu 
                            v-model="measurements.distant.od.dva"
                            :label="$t('measurementsLabels.dva')"
                            :options="dvaOptions"
                            :invalid="
            ...
            <div class="row" v-if="switchChecked">
                ...
                <div class="col-md-3 col-xxl-2">
                    <div class="form-group">
                        <CustomDropMenu 
                            v-model="measurements.distant.os.spherical"
                            :label="$t('measurementsLabels.spherical')"
                            :options="sphericalOptions"
                            :excludeColumn="0"
                            :invalid="
                ...
                <div class="col-md-3 col-xxl-2">
                    <div class="form-group">
                        <!-- Cylindrical -->
                        <CustomDropMenu 
                            v-model="measurements.distant.os.cylindrical"
                            :label="$t('measurementsLabels.cylindrical')"
                            :options="cylindricalOptions"
                            :excludeColumn="0"
                            :invalid="
                ...
                <div class="col-md-3 col-xxl-2">
                    <div class="form-group">
                        <!-- Axis -->
                        <CustomDropMenu 
                            v-model="measurements.distant.os.axis"
                            :label="$t('measurementsLabels.axis')"
                            :options="axisOptions"
                            :invalid="
                ...
                <div class="col-md-3 col-xxl-2">
                    <div class="form-group">
                        <!-- Add -->
                        <CustomDropMenu 
                            v-model="measurements.distant.os.add"
                            :label="$t('measurementsLabels.add')"
                            :options="addOptions"
                            :invalid="
                ...
                <div class="col-md-3 col-xxl-2" v-if="toggleSimpleOrAdvanced == 'advanced'">
                    <div class="form-group">
                        <!-- Prism -->
                        <CustomDropMenu 
                            v-model="measurements.distant.os.prism"
                            :label="$t('measurementsLabels.prism')"
                            :options="prismOptions"
                            :invalid="
                ...
                <div class="col-md-3 col-xxl-2" v-if="toggleSimpleOrAdvanced == 'advanced'">
                    <div class="form-group">
                        <!-- Dva -->
                        <CustomDropMenu 
                            v-model="measurements.distant.os.dva"
                            :label="$t('measurementsLabels.dva')"
                            :options="dvaOptions"
                            :invalid="
            ...
            <div class="row" v-if="switchChecked">
                ...
                <div class="col-md-3 col-xxl-2">
                    <div class="form-group">
                        <!-- Dva -->
                        <CustomDropMenu 
                            v-model="measurements.distant.ou.dva"
                            :label="$t('measurementsLabels.dva')"
                            :options="dvaOptions"
                            :invalid="
                ...
                <div class="col-md-3 col-xxl-2">
                    <div class="form-group">
                        <!-- NVA -->
                        <CustomDropMenu 
                            v-model="measurements.distant.ou.nva"
                            :label="$t('measurementsLabels.nva')"
                            :options="nvaOptions"
                            :invalid="
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="form-label">{{$t('measurements.note.label')}}</label>
                        <textarea 
                            v-model="measurements.note" 
                            :placeholder="$t('measurements.note.placeholder')" 
                            class="form-control"
                            :class="{
                                'is-invalid':
                                (v.note.$error)
                        ...
                        <div v-if="v.note.$error && !v.note.notContainsHtmlTags" class="invalid-feedback">
                                {{htmlTagsError($t('measurements.note.label'))}}
                        </div>
                        <div v-else-if="! v.note.minLength &&  v.note.$error" class="invalid-feedback">
                                {{minLengthError($t('measurements.note.label'), v.note.$params.minLength.min)}}
                        </div>
                        <div v-else-if="! v.note.maxLength &&  v.note.$error" class="invalid-feedback">
                                {{maxLengthError($t('measurements.note.label'), v.note.$params.maxLength.max)}}
                        </div> 
                    </div>
                </div>
            </div>
...
export default {
    ...
    ////////////////////////////////////
    computed: {
        ...mapGetters("detailsOphthalmic/ophthalmic", ["getMeasurements"]),
        measurements: {
            get() {
                return this.getMeasurements;
            },
            set(value) {
                this.$store.dispatch("detailsOphthalmic/ophthalmic/setMeasurements", value);
            },
        }
    },
    /////////////////////////////////////////////
    methods:{
        ...
        reset() {
           this.measurements = {
            ...
            this.toggleSimpleOrAdvanced ='advanced';
         },

        ///////////////////////////////
        copyToOdNear(){
                this.measurements.near.od=JSON.parse(JSON.stringify(this.measurements.near.os));
        },
        copyToOsNear(){
            this.measurements.near.os=JSON.parse(JSON.stringify(this.measurements.near.od));
        },
        copyToOdDistant(){
                this.measurements.distant.od=JSON.parse(JSON.stringify(this.measurements.distant.os));
        },
        copyToOsDistant(){
            this.measurements.distant.os=JSON.parse(JSON.stringify(this.measurements.distant.od));
        },
    },
}
</script>
