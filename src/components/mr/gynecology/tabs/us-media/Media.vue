<template>
  <div class="pregnancy-media">
    <div class="upload-area">
        <Base>
            <DropFile :staticRef="'drop-pregnancy-media'" v-model="inputFile" @ready="openAddDialog" 
            :accept="['image','video']"></DropFile>
        </Base>
    </div>
        ...
        <Base>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="p-2">
                        <span class="fw-bold">{{$t('uploadedDocs')}} :</span>
                        <span class="mx-2"><Badge severity="success" :value="recordsToDisplay.length"></Badge></span>
