<template>
  <div class="muscl-test">
      ...
      <div class="row">
        <div class="col-12 d-flex justify-content-between">
          <div class="form-group reset d-flex align-items-center" id="info">
            <h4 class="mb-0 me-2">Muscle Test</h4>
            <button
            ...
            <OverlayPanel
              ref="muscleTestInfoOp"
              appendTo="body"
              id="info_overlay_panel"
              style="width: 320px"
            >
              <h6 class="">QUOTATION FOR MUSCLE TESTING</h6>
              <span class="fs-12"
                >according to Manual Muscle Testing Oxford Scale</span
              >
              <ol class="mt-1 mb-0">
                <li><small>No contraction present</small></li>
                <li><small>Contraction visible without movement</small></li>
                <li>
                  <small
                    >Movement possible without gravity or incomplete against
                    gravity</small
                  >
                </li>
                <li>
                  <small
                    >Movement possible against gravity into the fullest
                    available range</small
                  >
                </li>
                <li>
                  <small
                    >Movement possible against gravity and an added moderate
                    resistance</small
                  >
                </li>
                <li><small>Muscle functions normally</small></li>
              </ol>
            </OverlayPanel>
          </div>
    ...
    <div class="table-wrapper my-2" v-if="muscleTest.length > 0">
      <Base>
        <div class="row my-2">
          <div class="col-12">
            <div class="table-responsive">
              <table class="table table-sm text-center">
                ...
                <tbody>
                  <tr v-for="(val, index) in muscleTest" :key="index">
...
export default {
  ...
  computed: {
    ...
    ...mapGetters("detailsPhysiotherapy/physiotherapy", {
      getMuscleTest: "getMuscleTest",
    }),
    muscleTest: {
      get() {
        return this.getMuscleTest;
      },
      set(value) {
        this.setMuscleTest(value);
      },
    },
  },
  validations: {
  ...
  methods: {
    ...mapActions("detailsPhysiotherapy/physiotherapy", ["setMuscleTest"]),
    htmlTagsError,
    maxLengthError,
    minLengthError,
    inputError,
    ...
    maxRecordsError,
    toggle(event) {
      this.$refs.muscleTestInfoOp.toggle(event);
    },
    resetForm() {
      this.rowToAdd = {
        muscle: [],
    ...
    addRow() {
      ...
      if (!(this.v.$invalid || this.$v.rowToAdd.$invalid)) {
        this.muscleTest.push({ ...this.rowToAdd });
        this.resetForm();
      }
    },
    /////////////////////
    ...
    editRow() {
      ...
      if (!this.$v.rowToEdit.$invalid) {
        this.muscleTest[this.indexToEdit] = { ...this.rowToEdit };
    ...
    deleteRow() {
      this.muscleTest.splice(this.indexToDelete, 1);
