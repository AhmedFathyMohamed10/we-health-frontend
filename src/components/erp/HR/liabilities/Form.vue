<template>
  ...
  import Form from "@/components/erp/HR/liabilities/categories/Form";
  ...
  export default {
    ...
    computed: {
      ...
      ...mapGetters("erp/hr/liabilities_categories", {
      ...
      // },
      categoriesOptions() {
        if (this.$store.getters["erp/hr/liabilities_categories/getListResponse"])
          return this.$store.getters["erp/hr/liabilities_categories/getListResponse"].results;
        else {
          return [];
        }
      },
    ...
    created() {
      ...
      if (!this.categoriesOptions.Length > 0) {
        ...
        this.$store.dispatch("erp/hr/liabilities_categories/list", params);
      }
    ...
    methods: {
      ...mapActions("erp/hr/liabilities_categories", [
        "setUpsertResponse",
        "setUpsertError",
        "setDeleteResponse",
        "setDeleteError",
      ...
      create() {
        this.$store
          .dispatch("erp/hr/liabilities_categories/create", this.categoryForm)
          .then((res) => {
            this.resetForm();
      ...
      update() {
        this.$store
          .dispatch("erp/hr/liabilities_categories/update", this.categoryForm)
          .then((res) => {
            this.resetForm();
            const summery = res.statusText;
            const details = res.data.message;
