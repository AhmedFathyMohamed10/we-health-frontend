  ...
  <div class="form">
    ...
    >
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="form-group">
            <label for="" class="form-label">{{ $t("form.type_product.label") }}</label>
                ...
                <Dropdown
                  ...
                  :optionLabel="locale"
                  optionValue="id"
                  :placeholder="$t('form.type_product.placeholder')"
                  :class="{
                    'p-invalid': $v.form.type_product.$error,
                  }"
                />
                <div class="error">
                  <small
                    class="p-invalid"
                    v-if="
                      !$v.form.type_product.required &&
                      $v.form.type_product.$error
                    "
                  >
                    {{ requiredError($t("form.type_product.label")) }}
                  </small>
                </div>
          </div>
        </div>
        <div class="col-md-12">
          <div class="form-group">
              ...
              ></textarea>
              <div
                v-if="!$v.form.description.notContainsHtmlTags && $v.form.description.$error"
                class="invalid-feedback"
              >
