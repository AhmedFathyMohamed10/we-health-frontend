          ...
          <div class="col-12">
            <div class="table-responsive">
              <table class="table table-sm text-center">
                ...
                <tbody>
                  <tr
                    v-for="(pricingPolicy, index) in pricingPolicies"
                    :key="index"
                  >
                    ...
                    <td class="align-middle">
                      <span>
                        <a
                          ...
                          @click="openDetailsDialog(pricingPolicy)"
                          >{{ pricingPolicy.name }}</a
                        >
                      </span>
                    </td>
                    <td class="align-middle">
                      ...
                      >
                        <EditButton
                          class="me-2"
                          @edit="openUpdate(pricingPolicy)"
                        ></EditButton>
                        <DeleteButton
                          @delete="openDeleteDialogSingle(pricingPolicy)"
                        ></DeleteButton>
                      </div>
                    </td>
                  </tr>
...
<i18n src="@/lang/erp/productAndService/PricingPolicy.json"></i18n>
<script>
import Base from "@/components/global/utilities/Base.vue";
import NoResults from "@/components/global/utilities/NoResults.vue";
import EditButton from "@/components/global/utilities/EditButton.vue";
import DeleteButton from "@/components/global/utilities/DeleteButton.vue";
import Form from "@/components/erp/productAndServices/PricingPolicy/Form.vue";
...
export default {
  ...
  computed: {
    ...
    ...mapGetters("erp/ProductAndService/PricingPolicy", {
  ...
  methods: {
    ...mapActions("erp/ProductAndService/PricingPolicy", [
      "setUpsertResponse",
      "setUpsertError",
      "setDeleteResponse",
      "setDeleteError",
    ...
    selectAllRecords() {
      this.selected = [];
      if (!this.selectAll) {
        for (let i in this.pricingPolicies) {
          this.selected.push(this.pricingPolicies[i]);
        }
      }
    },
    ////////// UPSERT ///////////////////
    ...
    create() {
      this.$store
        .dispatch("erp/ProductAndService/PricingPolicy/create", this.form)
        .then((res) => {
          this.resetForm();
          console.log(res)
    ...
    update() {
      console.log("akfwdjk");
      this.$store
        .dispatch("erp/ProductAndService/PricingPolicy/update", this.form)
        .then((res) => {
          this.resetForm();
          const summery = res.statusText;
          const details = res.data.message;
    ...
    deleteRecords() {
      this.$store
      .dispatch("erp/ProductAndService/PricingPolicy/delete", this.selected)
      .then((res) => {
    ...
    list() {
      this.$store.dispatch("erp/ProductAndService/PricingPolicy/list", this.filterParams).then(() => {
