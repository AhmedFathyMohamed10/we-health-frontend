<template>
            ...
            <div class="col-12">
              <div class="table-responsive">
                <table class="table table-sm text-center">
                  ...
                  <tbody>
                    <tr v-for="(unit, index) in productUnits" :key="index">
                      ...
                      <td class="align-middle">
                        ...
                        >
                          <EditButton
                            class="me-2"
                            @edit="openUpdate(unit)"
                          ></EditButton>
                          <DeleteButton
                            @delete="openDeleteDialogSingle(unit.code, 4)"
                          ></DeleteButton>
                        </div>
                      </td>
                    </tr>
  ...
  <i18n src="@/lang/erp/productAndService/productUnit.json"></i18n>
  <script>
  import Base from "@/components/global/utilities/Base.vue";
  import NoResults from "@/components/global/utilities/NoResults.vue";
  import EditButton from "@/components/global/utilities/EditButton.vue";
  import DeleteButton from "@/components/global/utilities/DeleteButton.vue";
  import Form from "@/components/erp/productAndServices/productUnit/Form.vue";
  ...
  export default {
    ...
    computed: {
      ...
      ...mapGetters("erp/ProductAndService/productUnit", {
    ...
    methods: {
      ...mapActions("erp/ProductAndService/productUnit", [
        "setUpsertResponse",
        "setUpsertError",
        "setDeleteResponse",
        "setDeleteError",
      ...
      selectAllRecords() {
        this.selected = [];
        if (!this.selectAll) {
          for (let i in this.productUnits) {
            this.selected.push(this.productUnits[i].code);
          }
        }
      },
      ...
      create() {
        this.$store
          .dispatch("erp/ProductAndService/productUnit/create", this.form)
          .then((res) => {
            this.resetForm();
      ...
      update() {
        this.$store
          .dispatch("erp/ProductAndService/productUnit/update", this.form)
          .then((res) => {
            this.resetForm();
            const summery = res.statusText;
      ...
      deleteRecords() {
        this.$store
          .dispatch("erp/ProductAndService/productUnit/changeStatus", {"action":this.actionStatus,"selected":this.selected})
          .then((res) => {
      ...
      list() {
        this.$store.dispatch("erp/ProductAndService/productUnit/list", this.filterParams).then(() => {
