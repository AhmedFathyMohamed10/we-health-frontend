                  ...
                  >
                    ...
                    <td class="align-middle">
                      <span>
                        <a
                          ...
                          @click="openDetailsDialog(mainCategory)"
                          >{{ mainCategory.name }}</a
                        >
                      </span>
                    </td>
                    <td class="align-middle">
                      ...
                      >
                        <EditButton
                          class="me-2"
                          @edit="openUpdate(mainCategory)"
                        ></EditButton>
                        <DeleteButton
                          @delete="openDeleteDialogSingle(mainCategory)"
                        ></DeleteButton>
                      </div>
                    </td>
                  </tr>
...
export default {
  ...
  methods: {
    ...mapActions("erp/ProductAndService/Category/MainCategory", [
      "setUpsertResponse",
      "setUpsertError",
      "setDeleteResponse",
      "setDeleteError",
    ...
    selectAllRecords() {
      this.selected = [];
      if (!this.selectAll) {
        for (let i in this.mainCategories) {
          this.selected.push(this.mainCategories[i]);
        }
      }
    },
    ////////// UPSERT ///////////////////
    ...
    create() {
      this.$store
        .dispatch("erp/ProductAndService/Category/MainCategory/create", this.form)
        .then((res) => {
          this.resetForm();
          // console.log(res)
    ...
    update() {
      this.$store
        .dispatch("erp/ProductAndService/Category/MainCategory/update", this.form)
        .then((res) => {
          this.resetForm();
          const summery = res.statusText;
          const details = res.data.message;
    ...
    deleteRecords() {
      ...
      this.$store
        .dispatch("erp/ProductAndService/Category/MainCategory/delete", this.selected)
        .then((res) => {
    ...
    list() {
      this.$store.dispatch("erp/ProductAndService/Category/MainCategory/list", this.filterParams).then(() => {
