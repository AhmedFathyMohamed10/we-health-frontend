<template>
                    ...
                    <tr v-for="(partner, index) in partners" :key="index">
                      ...
                      <td class="align-middle">
                        <span>
                          <a
                            ...
                            @click="openDetailsDialog(partner)"
                            >{{ partner.name }}</a
                          >
                        </span>
                      </td>
                      <td class="align-middle">
                        ...
                        >
                          <EditButton
                            class="me-2"
                            @edit="openUpdate(partner)"
                          ></EditButton>
                          <DeleteButton
                            @delete="openDeleteDialogSingle(partner.code, 4)"
                          ></DeleteButton>
                        </div>
                      </td>
                    </tr>
  ...
  <i18n src="@/lang/erp/partnersAndRatios/Partner.json"></i18n>
  <script>
  import Base from "@/components/global/utilities/Base.vue";
  import NoResults from "@/components/global/utilities/NoResults.vue";
  import EditButton from "@/components/global/utilities/EditButton.vue";
  import DeleteButton from "@/components/global/utilities/DeleteButton.vue";
  import Form from "@/components/erp/partnersAndRatios/partners/Form.vue";
  ...
  export default {
    ...
    computed: {
      ...
      ...mapGetters("erp/PartnersAndRatios/Partner", {
    ...
    methods: {
      ...mapActions("erp/PartnersAndRatios/Partner", [
        "setUpsertResponse",
        "setUpsertError",
        "setDeleteResponse",
        "setDeleteError",
      ...
      selectAllRecords() {
        ...
        if (!this.selectAll) {
          for (let i in this.partners) {
            this.selected.push(this.partners[i].code);
          }
        }
      },
      ...
      create() {
        this.$store
          .dispatch("erp/PartnersAndRatios/Partner/create", this.form)
          .then((res) => {
            this.resetForm();
      ...
      update() {
        this.$store
          .dispatch("erp/PartnersAndRatios/Partner/update", this.form)
          .then((res) => {
            this.resetForm();
            const summery = res.statusText;
      ...
      deleteRecords() {
        this.$store
          .dispatch("erp/PartnersAndRatios/Partner/changeStatus", {"action":this.actionStatus,"selected":this.selected})
          .then((res) => {
      ...
      list() {
        this.$store.dispatch("erp/PartnersAndRatios/Partner/list", this.filterParams).then(() => {
