<template>
    <div class="Group">
          ...
          <div class="row mt-5">
            <div class="col-md-12">
              <div class="d-flex flex-wrap">
                ...
                <div class="form-group mb-2 me-2">
                  <button class="btn btn-pill btn-success-gradient" @click="openNewForm" >
                    <span><i class="fa fa-plus fa-md"></i> </span>
        ...
        <Base>
          <div v-if="listLoading">
            <DataTable :value="[{}, {}, {}]">
              ...
              <Column field="group_serial" header="group_serial">
                <template #body>
                  <Skeleton></Skeleton>
                </template>
              </Column>
                  ...
                  <table class="table table-sm text-center">
                    <thead>
                      <tr>
                        ...
                        <th scope="col">{{ $t("form.group_serial.label") }}</th>
      ...
      <newForm  :isLoading="upsertLoading" :displayForm="displayNewForm" @close="resetForm" @cancel="closeNewForm"  :header="'Group Table'"></newForm>
      <EditDialog 
  ...
  import Form from '@/components/erp/demo/group/Form.vue';
  import newForm from '@/components/erp/demo/group/newForm.vue';
  ...
  export default {
    ...
    methods: {
      ...
      selectAllRecords() {
        ...
        if (!this.selectAll) {
          for (let i in this.group) {
            this.selected.push(this.group[i].id);
          }
        }
      },
      ////////// UPSERT ///////////////////
      ...
      create(){
        ...
        this.$store.dispatch("erp/group/create", this.form)
        .then((res) => {
          this.resetForm();
          // console.log(res)
      ...
      update(){
        ...
        this.$store.dispatch("erp/group/update", this.form)
        .then((res) => {
          this.resetForm();
          // console.log(res)
          const summery = res.statusText; 
      ...
      changeStatus() {
          this.$store.dispatch("erp/group/changeStatus",{action:this.statusAction,selected:this.selected})
          .then((res) => {
      ...
      deleteRecords() {
        this.$store.dispatch("erp/group/delete",  this.selected)
        .then((res) => {
      ...
      ///////////////// DETAILS /////////////////////////////
       ...
       list() {
        ...
        if(this.isSearching){
         ...
         this.$store.dispatch("erp/group/list", params)
         .then(() => { 
