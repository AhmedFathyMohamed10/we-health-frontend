...
<template>
  ...
  export default {
    ...
    methods: {
      ...
      create(){
        this.$store.dispatch("erp/hr/liabilities_categories/create", this.form)
        .then((res) => {
          this.resetForm();
          // console.log(res)
      ...
      update(){
        this.$store.dispatch("erp/hr/liabilities_categories/update", this.form)
        .then((res) => {
          this.resetForm();
          // console.log(res)
          const summery = res.statusText; 
      ...
      deleteRecords() {
        this.$store.dispatch("erp/hr/liabilities_categories/delete", this.selected)
        .then((res) => {
