                    ...
                    <tr v-for="(role, index) in roles" :key="index">
                      ...
                      <td class="align-middle">
                        <div class="d-flex justify-content-center align-items-center">
                          <EditButton class="me-2" @edit="openUpdate(role)"></EditButton>
                          <DeleteButton @delete="openDeleteDialogSingle(role.id)"></DeleteButton>
                        </div>
                      </td>  
                    </tr>
                  </tbody>
...
import Form from '@/components/erp/HR/roles/Form.vue';
...
export default {
  ...
  methods: {
    ...
    create(){
      this.$store.dispatch("erp/hr/roles/create", this.form)
      .then((res) => {
        this.resetForm();
        // console.log(res)
    ...
    update(){
      this.$store.dispatch("erp/hr/roles/update", this.form)
      .then((res) => {
        this.resetForm();
        // console.log(res)
        const summery = res.statusText; 
    ...
    deleteRecords() {
      this.$store.dispatch("erp/hr/roles/delete", this.selected)
      .then((res) => {
    ...
    ///////////////// DETAILS /////////////////////////////
     ...
     openDetailsDialog(record) {
      ...
      const {name,department_name,description,created_at} = record
      this.recordDetails = {name,department_name,description,created_at};
