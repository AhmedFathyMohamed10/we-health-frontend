...
<template>
                    ...
                    <tbody>
                      <tr v-for="(bonus, index) in bonuses" :key="index">
                        ...
                        <td class="align-middle fw-bold">
                          ...
                          <td class="align-middle fw-bold">
                            <span>{{ bonus.due_date }}</span>
                          </td>
                       
                        <td class="align-middle">
                          <div class="d-flex justify-content-center align-items-center">
                            <DetailButton class="me-2" @details="openDetailsDialog(bonus)" ></DetailButton>
                            <EditButton class="me-2" @edit="openUpdate(bonus)"></EditButton>
                            <DeleteButton @delete="openDeleteDialogSingle(bonus.code,4)"></DeleteButton>
                          </div>
                        </td>  
                      </tr>
                    </tbody>
  ...
  <i18n src="@/lang/erp/hr/bonus/bonus.json"></i18n>
  <script>
  import Base from "@/components/global/utilities/Base.vue";
  import NoResults from "@/components/global/utilities/NoResults.vue";
  import EditButton from "@/components/global/utilities/EditButton.vue"
  import DeleteButton from "@/components/global/utilities/DeleteButton.vue"
  import Form from '@/components/erp/HR/bonus/Form.vue';
  ...
  export default {
    ...
    methods: {
      ...
      selectAllRecords() {
        ...
        if (!this.selectAll) {
          for (let i in this.bonuses) {
            this.selected.push(this.bonuses[i].code);
          }
        }
      },
      ////////// UPSERT ///////////////////
      ...
      create(){
        this.$store.dispatch("erp/hr/bonus/create", this.form)
        .then((res) => {
          this.resetForm();
          // console.log(res)
      ...
      update(){
        this.$store.dispatch("erp/hr/bonus/update", this.form)
        .then((res) => {
          this.resetForm();
          // console.log(res)
          const summery = res.statusText; 
      ...
      deleteRecords() {
        this.$store.dispatch("erp/hr/bonus/delete", {'selected':this.selected,'action':this.statusAction})
        .then((res) => {
      ...
      ///////////////// DETAILS /////////////////////////////
       ...
       openDetailsDialog(record) {
        ...
        const {employee_name,group_name,amount,due_date,reason,created_at} = record
        this.recordDetails = {employee_name,group_name,amount,due_date,reason,created_at};
