<template>
  ...
  // import Form "@/components/erp/HR/internships/Bonus_Groups/Form.vue"
  ...
  export default {
    ...
    methods: {
      ...
      create() {
        this.$store
          .dispatch("erp/hr/bonus_groups/create", this.form)
          .then((res) => {
            this.resetForm();
            // console.log(res)
      ...
      update() {
        this.$store
          .dispatch("erp/hr/bonus_groups/update", this.form)
          .then((res) => {
            this.resetForm();
            // console.log(res)
            const summery = res.statusText;
      ...
      openDeleteDialog() {
        ...
        deleteRecords() {
          this.$store.dispatch("erp/hr/bonus_groups/delete", {'selected':this.selected,'action':this.statusAction})
          .then((res) => {
      ...
      list() {
        ...
        this.$store.dispatch("erp/hr/bonus_groups/list", params).then(() => {
