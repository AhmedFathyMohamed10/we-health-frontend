...
<template>
        ...
        <div class="row">
          <div class="col-md-5 col-xxl-3">
            <div class="form-group">
              ...
              />
              <div
              v-if="!$v.form.remind_before_appearing.required && $v.form.remind_before_appearing.$error"
  ...
  <i18n src="@/lang/erp/assets/settings/rentals.json"></i18n>
  <script>
...
export default {
  ...
  computed: {
    ...
    ...mapGetters("erp/Assets/setting/rentals", {
  ...
  methods: {
    requiredError,
    numericError,
    ...mapActions("erp/Assets/setting/rentals", [
      "setformResponse",
      "setUpsertResponse",
      "setUpsertError",
    ]),
    ...
    create() {
      ...
      if (!this.$v.form.$invalid) {
        this.$store
          .dispatch("erp/Assets/setting/rentals/create", this.form)
          .then((res) => {
    ...
    list() {
      this.$store.dispatch("erp/Assets/setting/rentals/list").then(() => {
        if (this.settings) {
