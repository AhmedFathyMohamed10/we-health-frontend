...
<template>
  <div class="Settings">
          ...
          <div class="col-md-5 col-xxl-3">
            <div class="form-group">
              <label class="form-label">
                {{ $t("form.remind_before_appearing.label") }} ({{
                  $t("day")
                }})
              </label>
              <input
                ...
                :placeholder="
                  $t('form.remind_before_appearing.placeholder')
                "
                class="form-control"
                :class="{
          ...
          <div class="col-md-5 col-xxl-3">
            <div class="form-group">
              ...
              <input
                ...
                :placeholder="
                  $t('form.report_continues_to_appear.placeholder')
                "
                class="form-control"
                :class="{
    ...
    <i18n src="@/lang/erp/assets/settings/installments.json"></i18n>
    <script>
...
export default {
  ...
  computed: {
    ...
    ...mapGetters("erp/Assets/setting/installments", {
  ...
  methods: {
    requiredError,
    numericError,
    ...mapActions("erp/Assets/setting/installments", [
      "setformResponse",
      "setUpsertResponse",
      "setUpsertError",
    ]),
    ...
    create() {
      ...
      if (!this.$v.form.$invalid) {
        this.$store
          .dispatch("erp/Assets/setting/installments/create", this.form)
          .then((res) => {
    ...
    list() {
      this.$store.dispatch("erp/Assets/setting/installments/list").then(() => {
        if (this.settings) {
