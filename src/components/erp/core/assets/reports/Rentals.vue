  ...
  <div class="Group-assets">
    ...
    <div class="search-wrapper my-2">
      <Base>
        <div class="row">
          <div class="col-12">
            <h4>{{ $t("rentals.header") }}</h4>
          </div>
        </div>
        <div class="row">
          <div class="col-md-5 col-xxl-3">
            <div class="form-group">
              <label class="form-label"> {{ $t("rentals.key.name") }} </label>
              <span
                :class="[
            ...
            <div class="d-flex flex-wrap">
              <div class="form-group mb-2 me-2">
                ...
                >
                  ...
                  <span class="mx-2">{{ $t("btns.all_rentals") }}</span>
                </button>
              </div>
            </div>
          </div>
      ...
      <Base>
        <div v-if="listLoading">
          <DataTable :value="[{}, {}, {}]">
            ...
            <Column field="value_rent" header="Value Rent">
              <template #body>
                <Skeleton></Skeleton>
              </template>
            </Column>
              ...
              <table class="table table-sm text-center">
                <thead>
                  <tr>
                    ...
                    <th scope="col">{{ $t("rentals.key.name") }}</th>
                    <th scope="col">{{ $t("rentals.key.value_rent") }}</th>
                  </tr>
                </thead>
                <tbody>
                  <tr v-for="(rent, index) in rentals" :key="index">
                    ...
                    <td class="align-middle">
                      <span>
                        <a
                          ...
                          @click="openDetailsDialog(rent[0])"
                          >{{ rent[0].name }}</a
                        >
                      </span>
                    </td>
...
<i18n src="@/lang/erp/assets/reports/Rentals.json"></i18n>
<i18n src="@/lang/erp/assets/FixedAssets.json"></i18n>
  ...
  export default {
    ...
    computed: {
      ...
      ...mapGetters("erp/Assets/report/rentals", {
  ...
  // 
    ...
    methods: {
      ...mapActions("erp/Assets/report/rentals", [
        "setUpsertResponse",
        "setUpsertError"
      ]),
...
////////////// DETAILS /////////////////////////////
      ...
      list() {
        this.$store.dispatch("erp/Assets/report/rentals/list", this.filterParams).then(() => {
