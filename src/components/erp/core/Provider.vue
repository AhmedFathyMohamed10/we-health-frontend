          ...
          <div class="col-12">
            <div class="table-responsive">
              <table class="table table-sm text-center">
                ...
                <tbody>
                  <tr v-for="(agent, index) in providers" :key="index">
                    ...
                    <td class="align-middle">
                      ...
                      >
                        <EditButton
                          class="me-2"
                          @edit="openUpdate(agent)"
                        ></EditButton>
                        <DeleteButton
                          @delete="openDeleteDialogSingle(agent)"
                        ></DeleteButton>
                      </div>
                    </td>
                  </tr>
...
import Form from "@/components/erp/providers/Form.vue";
...
export default {
  ...
  computed: {
    ...
    ...mapGetters("erp/providers/Providers", {
  ...
  methods: {
    ...mapActions("erp/providers/Providers", [
      "setUpsertResponse",
      "setUpsertError",
      "setDeleteResponse",
      "setDeleteError",
    ...
    selectAllRecords() {
      ...
      if (!this.selectAll) {
        for (let i in this.providers) {
          this.selected.push(this.providers[i]);
        }
      }
    },
    ////////// UPSERT ///////////////////
    ...
    create() {
      ...
      this.$store
        .dispatch("erp/providers/Providers/create", this.form)
        .then((res) => {
          this.resetForm();
          // console.log(res)
    ...
    update() {
      this.$store
        .dispatch("erp/providers/Providers/update", this.form)
        .then((res) => {
          this.resetForm();
          const summery = res.statusText;
          const details = res.data.message;
    ...
    changeStatus() {
      this.$store
        .dispatch("erp/providers/Providers/changeStatus", {
    ...
    deleteRecords() {
      this.statusAction = 4;
      this.$store
        .dispatch("erp/providers/Providers/delete", this.selected)
        .then((res) => {
    ...
    openDetailsDialog(record) {
      const { name, mobile, email, address, status, updated_at } = record;
      this.recordDetails = { name, mobile, email, address, status, updated_at };
      this.displayDetailsDialog = true;
    },
    list() {
      this.$store.dispatch("erp/providers/Providers/list", this.filterParams).then(() => {
