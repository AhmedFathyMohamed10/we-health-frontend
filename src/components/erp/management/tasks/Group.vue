...
<i18n src="@/lang/erp/management/tasks/group.json"></i18n>
<script>
import Base from "@/components/global/utilities/Base.vue";
import NoResults from "@/components/global/utilities/NoResults.vue";
import EditButton from "@/components/global/utilities/EditButton.vue";
import DeleteButton from "@/components/global/utilities/DeleteButton.vue";
import Form from "@/components/erp/management/tasks/group/Form.vue";
...
export default {
  ...
  computed: {
    ...mapGetters("erp/management/tasks/group", {
  ...
  methods: {
    ...mapActions("erp/management/tasks/group", [
      "setUpsertResponse",
      "setUpsertError",
    ]),
    /////////////////////////////////////////
    ...
    create() {
      this.$store
        .dispatch("erp/management/tasks/group/create", this.form)
        .then((res) => {
          this.resetForm();
          // console.log(res)
    ...
    update() {
      this.$store
        .dispatch("erp/management/tasks/group/update", this.form)
        .then((res) => {
          this.resetForm();
          const summery = res.statusText;
          const details = res.data.message;
    ...
    deleteRecords() {
      this.$store
        .dispatch("erp/management/tasks/group/changeStatus", {action: this.statusAction,selected: this.selected})
        .then((res) => {
    ...
    list() {
      this.$store.dispatch("erp/management/tasks/group/list", this.filterParams).then(() => {
