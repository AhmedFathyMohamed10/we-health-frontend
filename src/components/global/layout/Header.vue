      ...
      <div class="d-flex">
        ...
        <a class="logo-horizontal" href="#">
          ...
          <img
            ...
            alt="logo"
          /> -->
          <img src="@/assets/global/logo/BONDS.svg" alt="logo" class="header-brand-img desktop-logo" width="200">
          <img src="@/assets/global/logo/Logo.svg" alt="logo" class="header-brand-img light-logo1" width="200">
        </a>
        <!-- LOGO -->
                    ...
                    <div class="header-dropdown-list message-menu">
                      <div class="dropdown-item d-flex p-4">
                        ...
                        <span
                          ...
                          data-bs-image-src="/assets/images/pngs/4.jpg"
                        ></span>
                        <div class="wd-50p">
                      ...
                      <div class="dropdown-item d-flex p-4">
                        ...
                        <span
                          class="avatar avatar-xl br-5 me-3 align-self-center cover-image"
                          data-bs-image-src="/assets/images/pngs/6.jpg"
                        ></span>
                        <div class="wd-50p">
                      ...
                      <div class="dropdown-item d-flex p-4">
                        ...
                        <span
                          class="avatar avatar-xl br-5 me-3 align-self-center cover-image"
                          data-bs-image-src="/assets/images/pngs/8.jpg"
                        ></span>
                        <div class="wd-50p">
                      ...
                      <div class="dropdown-item d-flex p-4">
                        ...
                        <span
                          class="avatar avatar-xl br-5 me-3 align-self-center cover-image"
                          data-bs-image-src="/assets/images/pngs/1.jpg"
                        ></span>
                        <div class="wd-50p">
                      ...
                      <div class="dropdown-item d-flex p-4">
                        ...
                        <span
                          class="avatar avatar-xl br-5 me-3 align-self-center cover-image"
                          data-bs-image-src="/assets/images/pngs/3.jpg"
                        ></span>
                        <div class="wd-50p">
...
<script>
import Language from '@/components/global/utilities/Language.vue';
import Theme from '@/components/global/utilities/Theme.vue';
export default {
  components: {
    Language,
    Theme
