        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <Base>
              ...
              <div class="col-md-12" v-if="flagType == 2 || isUpdating">
                <div class="form-group">
                  <label for="" class="form-label">{{
                    $t("form.parent.label")
                  }}</label>
                ...
                <!-- <div class="form-group">
                  ...
                  <AutoComplete
                    ...
                    field="name_en"
                    :placeholder="$t('form.parent.placeholder')"
                    @complete="search($event, groupSuggestions)"
                  /> -->
                  <!-- :class="{ 'p-invalid': $v.form.parent.$error }" -->
                <!-- </div> -->
              </div>
            </Base>
          </div>
        </div>
        <template #footer-edite v-if="isUpdating">
          <Button
