<template>
  <div class="account">
    ...
    <Form v-model="form" :isLoading="upsertLoading" :isUpdating="isUpdating" :displayForm="displayForm"
...
import Move from "@/components/erp_v2/invoices/invoiceDefinition/Move.vue";
...
export default {
  ...
  data() {
    return {
      ...
      form:{
        ...
        applyCustomerDiscountToInvoiceItems:false,
    generateReceiptsNumberForDay:false,
    generateReceiptsNumbersForEachClosure:false,
    allowToMakeItemQuantityEqualToZero:false,
    allowToSaleLessThanPurchasePrice:false,
    allowInputExpiredDate:false,
    allowToOutputItemsInNegative:false,
    allowDuplicatedSerialNumber:false,
    preventPaymentMethodModify:false,
    preventDefaultDateModify:false,
    preventDefaultStoreModify:false,
    preventDefaultCustomerAccountModify:false,
    preventItemsAccountModify:false,
    preventCashAccountModify:false,
    preventPriceModify:false,
    preventGiftsModify:false,
    preventInvoiceDiscountModify:false,
    preventInvoiceNumberModify:false,
    preventDueDateModify:false,
    // autoPrintAfterSavingNewInvoice:false,
    // showPricingOptionsOnInvoicePrint:false,
    // printReceiptAfterPrintingTheInvoice:false,
    // printInvoiceExpenses:false,
    // printCustomizedItemsAfterInvoicePrint:false,
    // autoPrintAfterInvoiceEdit:false,
    // printCompoundItemsWithInvoice:false,
    // printCompoundItemsOnly:false,
    // printRawItemsWithCompoundItems:false,
    // showWindowTypesOfReportsToBePrinted:false,
    // groupRawAndSingularItems:false,
    // printSalesmanItemsWithTheInvoice:false,
    // printItemNameWithSerials:false,
    // showDebitAndCreditLabel:false,
    // printDetailedTaxesWithTheInvoice:false,
    subjectToTaxSystem:false,
    itemPriceIncludeTheTax:false,
    transferTheTaxToTaxAccount:false,
    preventDefaultTaxModify:false,
      },
      isPaginating: false,
      isSearching: false,
      isSearch: false,
  ...
  methods: {
    ...
    update() {
      ...
      this.$store
        .dispatch("erp_v2/invoices/invoiceDefinition/update", this.form)
        .then((res) => {
          this.resetForm();
          const summery = res.statusText;
    ...
    deleteRecords() {
      this.$store
        .dispatch("erp_v2/invoices/invoiceDefinition/changeStatus", {
    ...
    moveItem(data) {
      this.$store
        .dispatch("erp_v2/invoices/invoiceDefinition/move", {
          group: data,
          selected: this.selected,
        })
        .then((res) => {
    ...
    list() {
      this.$store
        .dispatch("erp_v2/invoices/invoiceDefinition/list", this.filterParams)
        .then(() => {
