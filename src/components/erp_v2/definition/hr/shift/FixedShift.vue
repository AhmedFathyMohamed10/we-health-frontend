...
export default {
  ...
  computed: {
    ...
    listFixedResponse() {
      return this.getListFixedResponse;
    },
    shifts() {
      if (this.listFixedResponse) {
        let filteredResults = this.listFixedResponse.results.filter(result => result.arr.length > 0);
    ...
    ...mapGetters("erp_v2/hr/shiftRecord", {
      getListFixedResponse: "getListFixedResponse",
