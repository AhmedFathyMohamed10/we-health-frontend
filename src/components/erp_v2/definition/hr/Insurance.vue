          ...
          <Base>
            <div v-if="listLoading">
              <DataTable :value="[{}, {}, {}]">
                ...
                <Column field="period_from" header="Period From">
                  <template #body>
                    <Skeleton></Skeleton>
                  </template>
                </Column>
                <Column field="period_to" header="Period To">
                  <template #body>
                    <Skeleton></Skeleton>
                  </template>
                </Column>
...
<i18n src="@/lang/erp_v2/hr/insurance.json"></i18n>
<script>
...
import Form from "@/components/erp_v2/hr/insurance/Form.vue";
...
export default {
  ...
  computed: {
    ...
    ...mapGetters("erp_v2/hr/insurance", {
  ...
  // },
  methods: {
    ...mapActions("erp_v2/hr/insurance", [
      "setUpsertResponse",
      "setUpsertError",
      "setDeleteResponse",
      "setDeleteError",
    ...
    create() {
      ...
      this.$store
        .dispatch("erp_v2/hr/insurance/create", this.form)
        .then((res) => {
          this.resetForm();
    ...
    update() {
      ...
      this.$store
        .dispatch("erp_v2/hr/insurance/update", this.form)
        .then((res) => {
          this.resetForm();
          const summery = res.statusText;
    ...
    deleteRecords() {
      this.$store
        .dispatch("erp_v2/hr/insurance/changeStatus", {"action":this.actionStatus,"selected":this.selected})
        .then((res) => {
    ...
    list() {
      this.$store.dispatch("erp_v2/hr/insurance/list", this.filterParams).then(() => {
