...
import EditDialog from "@/components/global/utilities/EditDialog.vue";
  ...
  import Form from "@/components/erp_v2/hr/reward/Form.vue";
  ...
  methods: {
    ...
    selectAllRecords() {
      ...
      if (!this.selectAll) {
        for (let i in this.rewards) {
          this.selected.push(this.rewards[i].code);
        }
      }
    },
    ...
    create() {
      this.$store
        .dispatch("erp_v2/hr/reward/create", this.form)
        .then((res) => {
          this.resetForm();
    ...
    update() {
      this.$store
        .dispatch("erp_v2/hr/reward/update", this.form)
        .then((res) => {
          this.resetForm();
          const summery = res.statusText;
    ...
    deleteRecords() {
      this.$store
        .dispatch("erp_v2/hr/reward/changeStatus", {"action":this.actionStatus,"selected":this.selected})
        .then((res) => {
    ...
    list() {
      this.$store.dispatch("erp_v2/hr/reward/list", this.filterParams).then(() => {
