<template>
  ...
  <i18n src="@/lang/erp_v2/b2b/companyType.json"></i18n>
  <script>
  ...
  export default {
    ...
    methods: {
      ...mapActions("erp_v2/company_type/", [
        "setUpsertResponse",
        "setUpsertError",
        "setDeleteResponse",
        "setDeleteError",
      ...
      create() {
        this.$store
          .dispatch("erp_v2/company_type/create", this.form)
          .then((res) => {
            this.resetForm();
      ...
      update() {
        this.$store
          .dispatch("erp_v2/company_type/update", this.form)
          .then((res) => {
            this.resetForm();
            // const summery = res.statusText;
      ...
      deleteRecords() {
        this.$store
          .dispatch("erp_v2/company_type/delete", {
      ...
      list() {
        ...
        this.$store.dispatch("erp_v2/company_type/list", this.filterParams).then(() => {
