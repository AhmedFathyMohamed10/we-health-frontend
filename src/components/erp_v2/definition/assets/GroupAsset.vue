...
<script>
import FixedAsset from "@/components/erp_v2/definition/assets/FixedAsset.vue";
...
export default {
  ...
  methods: {
    ...
    deleteGroup(data) {
      ...
      this.actionStatus = 4;
      this.$store
        .dispatch("erp_v2/assets/assetGroup/delete", {
    ...
    update() {
      this.$store
        .dispatch("erp_v2/assets/assetGroup/update", this.form)
        .then((res) => {
          this.resetForm();
          this.nodes = this.groups
          const summery = res.statusText;
    ...
    /////////////////////////////////
    list() {
      this.$store.dispatch("erp_v2/assets/assetGroup/list").then(() => { });
    },
    moveItem(value) {
