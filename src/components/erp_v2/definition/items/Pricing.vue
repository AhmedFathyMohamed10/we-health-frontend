                  ...
                  <table class="table table-sm text-center">
                    ...
                    <tbody>
                      <tr v-for="(price, index) in prices" :key="index">
                        ...
                        <td class="align-middle">{{ price.name_ar }}</td>
                        <td class="align-middle">{{ price.account_name }}</td>
                        <td class="align-middle">
                          <div
...
<i18n src="@/lang/erp_v2/items/price.json"></i18n>
<script>
...
export default {
  ...
  methods: {
    ...
    update() {
      this.$store
        .dispatch("erp_v2/items/price/update", this.form)
        .then((res) => {
          this.resetForm();
          const summery = res.statusText;
    ...
    deleteRecords() {
      this.$store
        .dispatch("erp_v2/items/price/changeStatus", {"action":this.actionStatus,"selected":this.selected})
        .then((res) => {
    ...
    list() {
      this.$store.dispatch("erp_v2/items/price/list", this.filterParams).then(() => {
