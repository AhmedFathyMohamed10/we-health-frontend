    ...
    return {
      lang: {
        en: {
          ...
          // diagnosis is the sections in the diagnosis tap
          diagnosis: {
            diagnosisActions: {
              category: "category",
            ...
            diagnosis: {
              other: "other",
              endodentTreatment: "endodont treatment",
              crown: "crown",
              filling: "filling",
              caries: "caries",
              fracture: "fracture",
          ...
          lab: {
            headers: {
              ...
              marginPlease:
                "Please select your choice(s) of margin combination for PFM",
            },
            labForm: {
              headers: {
                Pfm: "PFM",
      ...
      // mainOptions is the taps of the dental clinic
      mainOptions: [
        {
          english: "diagnosis",
          arabic: "diagnosis",
      ...
      options: {
        // main is  the fixed  buttons in each tap
        main: {
          diagnosis: [
            {
            ...
            {
              arabic: "gallery & X-rays",
              english: "gallery & X-rays",
              id: 3,
            },
          ],
          operations: [
        ...
        //  diagnosis object contains the Category buttons in the diagnosis tap
        diagnosis: {
          //  diagnosisSubOptions the buttons titles
          diagnosisSubOptions: [
            {
              english: "extraction",
              arabic: "extraction",
          ...
          diagnosisActions: {
            // categoryTypeActions is the Category Type buttons actions for each Category
            categoryTypeActions: {
              BoneRegeneration: [],
              extraction: [
                {
              ...
              endo: [
                ...
                {
                  english: "pulp regeneration",
                  arabic: "pulp regeneration",
                },
                {
                  english: "Apexification",
                  arabic: "Apexification",
                },
                {
              ...
              implant: [
                ...
                {
                  english: "Malpositioned",
                  arabic: "Malpositioned",
                },
                {
            ...
            // styleActions is the title buttons of style for each Category
            styleActions: {
              //  edit
              ortoFacialTMJ: [],
              BoneRegeneration: [],
            ...
            // the  Diagnosis section under the toothes section
            diagnosisAction: {
              extraction: [
                {
                  english: "history",
          ...
          //   diagnosisSubAction button titles under  Diagnosis section under the toothes section
                ...
                eshetics: [
                  {
                    other: [
                      {
                        english: "bad aesthetics ",
                        arabic: "bad aesthetics ",
                      },
                ...
                material: [
                  {
                    other: [
                      ...
                      {
                        english: "zinc oxide eugenol",
                        arabic: "zinc oxide eugenol",
                      },
                ...
                material: [
                  {
                    other: [
                      ...
                      {
                        english: "condensation silicon",
                        arabic: "condensation silicon",
                      },
        ...
        // operations object contains the Category buttons in the operations tap
        operations: {
          diagnosisSubOptions: [
            {
              english: "extraction",
        ...
        // planning object contains the Category buttons in the operations tap
